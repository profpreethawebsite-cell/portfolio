        ...
        {awards.length === 0 ? (
          ...
          awards.map((award) => (
            <motion.div
              ...
              className="bg-gradient-to-br from-white to-indigo-50 rounded-lg shadow-md p-6 hover:shadow-xl transition-all border border-gray-100 relative overflow-hidden"
            >
